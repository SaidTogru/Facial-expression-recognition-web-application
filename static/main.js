      ...
      if (navigator.getUserMedia) {
        navigator.getUserMedia (
          ...
          function(stream) {
            ...
            frameLoop();
            $.post( "/stream_mode", { status: stream_mode});
...
function activateLoadingStream(){
  $("#stream-loading").css({background: "-webkit-gradient(linear, left top, left bottom, from(#FFFFFF), to(#000000))" });
